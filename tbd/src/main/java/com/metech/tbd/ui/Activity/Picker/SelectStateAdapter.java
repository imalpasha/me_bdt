...
public class SelectStateAdapter extends BaseAdapter {
    ...
    String[] filteredChar;
    SelectStateFragment frag;

    public SelectStateAdapter(Context context, SelectStateFragment frag, ArrayList<DropDownItem> countries, ArrayList<DropDownItem> oriCountries) {
