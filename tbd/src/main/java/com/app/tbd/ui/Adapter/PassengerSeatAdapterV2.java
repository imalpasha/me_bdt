...
public class PassengerSeatAdapterV2 extends BaseAdapter {
    ...
    public PassengerSeatAdapterV2(Context context, List<PasssengerInfoV2> passengers, SeatSelectionFragment fragment) {
